  ...
  useEffect(() => {
    ...
    try {
      return (
        ...
        <View style={styles.section}>
          ...
          <View style={styles.summaryGrid}>
            <View style={styles.summaryCard}>
              <Text style={styles.summaryLabel}>{t('report.totalEnergy')}</Text>
              <Text style={styles.summaryValue}>{formatNumber(reportSummary.totalEnergy)} kWh</Text>
              <Text style={styles.summaryChange}>+12.5%</Text>
            </View>
            <View style={styles.summaryCard}>
              <Text style={styles.summaryLabel}>{t('report.avgPower')}</Text>
              <Text style={styles.summaryValue}>{reportSummary.avgPower} kW</Text>
              ...
              <View key={index} style={styles.deviceCard}>
                ...
                <View style={styles.deviceStats}>
                  <View style={styles.deviceStat}>
                    ...
                    <Text style={styles.deviceStatValue}>{device.energy} kWh</Text>
                  </View>
                  <View style={styles.deviceStat}>
                  ...
                  <View style={styles.deviceStat}>
                    ...
                    <Text style={styles.deviceStatValue}>{device.avgPower} kW</Text>
                  </View>
                  <View style={styles.deviceStat}>
        ...
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>{t('report.monthlySummary')}</Text>
          <View style={styles.chartContainer}>
                         {viewMode === 'chart' ? (
               <SafeChartWrapper>
                 <SimpleLineChart
              ...
              <View style={styles.textView}>
                ...
                {reportData.monthlyReport.averagePower.map((item, index) => (
                  <View key={index} style={styles.textRow}>
                    ...
                    <Text style={styles.textValue}>{item.value} kW</Text>
                  </View>
                ))}
              </View>
            )}
                ...
                {getChargingDataText().map((item, index) => (
                  <View key={index} style={styles.textRow}>
                    ...
                    <Text style={styles.textDetail}>
                      ({item.totalEnergy} kWh, {item.avgPower} kW)
                    </Text>
                  </View>
                ))}
              </View>
        ...
        {/* Daily Energy Chart */}
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>{t('report.dailyEnergy')}</Text>
          <View style={styles.chartContainer}>
                         {viewMode === 'chart' ? (
               <View style={styles.chartWrapper}>
                 <SafeChartWrapper>
                   <SimpleBarChart
                     ...
                     height={220}
                     xAxisLabel="Ngày"
                     yAxisLabel="Năng lượng (kWh)"
                   />
                 </SafeChartWrapper>
                <View style={styles.chartInfo}>
                  <Text style={styles.chartInfoText}>Năng lượng tiêu thụ hàng ngày</Text>
                  <Text style={styles.chartInfoText}>
                    Tổng: {reportData.dailyEnergy.reduce((sum, item) => sum + item.energy, 0).toFixed(1)} kWh
                  </Text>
                  <Text style={styles.chartInfoText}>
                    Trung bình: {(reportData.dailyEnergy.reduce((sum, item) => sum + item.energy, 0) / reportData.dailyEnergy.length).toFixed(1)} kWh/ngày
                  </Text>
                </View>
              </View>
            ) : (
              <View style={styles.textView}>
                ...
                <View style={styles.textSummary}>
                  ...
                  <Text style={styles.textSummaryValue}>
                    {reportData.dailyEnergy.reduce((sum, item) => sum + item.energy, 0).toFixed(1)} kWh
                  </Text>
                </View>
                <View style={styles.textSummary}>
                  <Text style={styles.textSummaryLabel}>Trung bình/ngày:</Text>
                  <Text style={styles.textSummaryValue}>
                    {(reportData.dailyEnergy.reduce((sum, item) => sum + item.energy, 0) / reportData.dailyEnergy.length).toFixed(1)} kWh
                  </Text>
                </View>
                <View style={styles.textSummary}>
                  <Text style={styles.textSummaryLabel}>Ngày cao nhất:</Text>
                  <Text style={styles.textSummaryValue}>
                    {Math.max(...reportData.dailyEnergy.map(item => item.energy)).toFixed(1)} kWh
                  </Text>
                </View>
                <View style={styles.textSummary}>
                  <Text style={styles.textSummaryLabel}>Ngày thấp nhất:</Text>
                  <Text style={styles.textSummaryValue}>
                    {Math.min(...reportData.dailyEnergy.map(item => item.energy)).toFixed(1)} kWh
                  </Text>
                </View>
                ...
                {reportData.dailyEnergy.map((item, index) => (
                  <View key={index} style={styles.textRow}>
                    ...
                    <Text style={styles.textValue}>{item.energy} kWh</Text>
                  </View>
                ))}
              </View>
            )}
        ...
        {/* Power Time Chart */}
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>{t('report.powerTime')}</Text>
          <View style={styles.chartContainer}>
                         {viewMode === 'chart' ? (
               <View style={styles.chartWrapper}>
                 <SafeChartWrapper>
                ...
                <View style={styles.chartInfo}>
                  ...
                  <Text style={styles.chartInfoText}>
                    Công suất giảm dần từ {reportData.powerTime[0]?.power} kW xuống {reportData.powerTime[reportData.powerTime.length - 1]?.power} kW
                  </Text>
                </View>
              </View>
            ) : (
              <View style={styles.textView}>
                ...
                <View style={styles.textSummary}>
                  ...
                  <Text style={styles.textSummaryValue}>{reportData.powerTime[0]?.power} kW</Text>
                </View>
                <View style={styles.textSummary}>
                  <Text style={styles.textSummaryLabel}>Công suất cuối:</Text>
                  <Text style={styles.textSummaryValue}>{reportData.powerTime[reportData.powerTime.length - 1]?.power} kW</Text>
                </View>
                <View style={styles.textSummary}>
                  <Text style={styles.textSummaryLabel}>Công suất trung bình:</Text>
                  <Text style={styles.textSummaryValue}>
                    {(reportData.powerTime.reduce((sum, item) => sum + item.power, 0) / reportData.powerTime.length).toFixed(1)} kW
                  </Text>
                </View>
